...
// CREATE TABLE db_user (login varchar, password varchar, permissions varchar, token_id uuid, token_created_on timestamp, PRIMARY KEY (login));
...
// CREATE TABLE db_user_token (token_id uuid, login varchar, permissions varchar, token_created_on timestamp, PRIMARY KEY (token_id));
